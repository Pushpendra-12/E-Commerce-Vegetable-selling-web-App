                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            <li class="nav-item"><a class="nav-link" href="http://localhost:8080/index.html">Home</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="http://localhost:8080/about.html">About
                                    Us</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    href="http://localhost:8080/gallery.html">Gallery</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="/feedback/addfeedback">Contact Us</a></li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
            ...
            <div class="container">
                <div class="row new-account-login">
                    ...
                    <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        <form:form action="/customer/addcustomerprocess" method="post" modelAttribute="customer"
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <form:input path="address.address" class="form-control" id="address"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <form:input path="address.pinCode" class="form-control" id="pin"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="Email1" class="mb-0">Email Address</label>
                                        <form:input path="emailId" class="form-control" id="Email1"
                                            placeholder="Enter Email" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="Password1" class="mb-0">Password</label>
