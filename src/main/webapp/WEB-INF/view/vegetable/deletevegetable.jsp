            ...
            <div class="container">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h3><a data-toggle="collapse" href="#formRegister" role="button" aria-expanded="false">Enter
                            vegetable Id to delete</a></h3>
                    <form:form action="/vegetable/vegetablesearchfordelete" method="get" modelAttribute="vegetable"
                        class="mt-3 collapse review-form-box" id="formRegister">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="id" class="mb-0"> Vegetable Id</label>
